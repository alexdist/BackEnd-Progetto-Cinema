...
public class DecrementaPrezzoBigliettiCommand implements Command {
    ...
    public DecrementaPrezzoBigliettiCommand(double diminuzioneIntero, double diminuzioneRidotto) {
