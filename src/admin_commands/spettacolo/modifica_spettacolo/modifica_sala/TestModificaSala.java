...
//
//            // Comando per aggiungere una sala
//            ISala nuovaSala2 = new Sala(5, 150); // ID sarà assegnato automaticamente
//            ICommand aggiungiSalaCommand2 = new AggiungiSalaCommand(servizioAggiungiSala, nuovaSala2);
...
//            ISala salaSelezionata2 = RicercaSala.trovaSalaPerNumeroEId(sale, 5,1);
//
...
//            // }
//            //IAggiungiSpettacolo servizioAggiungiSpettacolo2 = new AggiungiSpettacolo(spettacoli,generatoreIDSpettacoloFactory);
...
//
//
//            IModificaSpettacolo servizioModificaSalaSpettacolo = new ModificaSpettacolo(spettacoli);
//            ICommand modificaSalaSpettacoloCommand = new ModificaSalaPerIdSpettacoloCommand(servizioModificaSalaSpettacolo,0,salaSelezionata2); //L'ID da passare è uello dello spettacolo che si vuole modificare
...
//                System.out.println("SALA: "+spettacolo.getSala().getNumeroSala());
//            }
//
//
//
