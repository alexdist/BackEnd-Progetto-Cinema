...
//
//public class GestioneCinema implements OperazioniCinema, Serializable {
...
//
//@Override
//    public boolean creaSpettacolo(String idSpettacolo, Film film, Sala sala, LocalDateTime orarioProiezione) throws SalaNonEsistenteException, FilmNonInProgrammazioneException, SovrapposizioneSpettacoloException, IDSpettacoloEsistenteException {
//
//        // Verifica l'esistenza della sala
//        if (sala == null) {
//            throw new SalaNonEsistenteException("La Sala non esiste.");
//        }
...
//            if (spettacoloEsistente.getSala().getNumeroSala() == sala.getNumeroSala()) {
